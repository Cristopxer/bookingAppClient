...
function PropertyList() {
    return (
        <div className="pList">
            ...
            <div className="pListItem">
                <img src="https://r-xx.bstatic.com/xdata/images/xphoto/300x240/45450082.jpeg?k=beb101b827a729065964523184f4db6cac42900c2415d71d516999af40beb7aa&o=" alt="" className='pListImg' />
                <div className="pListTitles">
                    <h1>Hostals</h1>
                    <h2>133 hostals</h2>
                </div>
